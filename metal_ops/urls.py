...
from .views import (
    CrearSedeView, CrearClienteView, CrearOrdenTrabajoView, ListarOrdenTrabajoView, EditarOrdenTrabajoView,
...
urlpatterns = [
    ...
    path('sedes/lista/', ListarClienteView.as_view(), name='lista-sede'),
    ...
    path('clientes/editar/', EditarClienteView.as_view(), name='editar-cliente'),
    path('clientes/eliminar/', EliminarClienteView.as_view(), name='eliminar-cliente'),
    ...
    path('ordenes/editar/', EditarOrdenTrabajoView.as_view(), name='editar-orden'),
    path('ordenes/eliminar/', EliminarOrdenTrabajoView.as_view(), name='eliminar-orden'),
    ...
    path('tareas/editar/', EditarTareaView.as_view(), name='editar-tarea'),
    path('tareas/eliminar/', EliminarTareaView.as_view(), name='eliminar-tarea'),
